...
mac_address = "B8:D6:1A:5C:EC:32"   #BLE mac address 1번ESP:"A8:42:E3:47:6E:16" 2번ESP:"B0:A7:32:DC:E5:66" 5pin: "B8:D6:1A:5C:EC:32" c-type: "D8:13:2A:7D:B2:68"
                ...
                for char in service.characteristics:    #서비스를 검색하고 notify_characteristic_uuid와 일치하는것을 찾음.
                    if char.uuid == notify_characteristic_uuid:
                        try:
                            ...
                            with open('final_txt.txt', 'r') as f: #파일 열기
